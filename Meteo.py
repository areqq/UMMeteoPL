...
class Meteo(Screen):
	...
	skin="""
		<screen name="UMMeteo" position="center,15" size="820,700" flags="wfNoBorder" backgroundColor="#00FFFFFF" >
			...
			<eLabel text="Konfiguracja" position="0,660" size="200,30" zPosition="2" font="Regular;22" halign="center" backgroundColor="red" />
			<eLabel text="Ulubione" position="200,660" size="200,30" zPosition="2" font="Regular;22" halign="center" backgroundColor="green" />
			<eLabel name="info2" text="www.meteo.pl %s by areq 2013" position="400,660" size="420,30" zPosition="2" font="Regular;22" halign="right" />
		</screen>""" % version
	...
	def start_meteo(self, id ):
		...
		url = "http://new.meteo.pl/um/php/meteorogram_id_um.php?ntype=0u&id=%s" % id
	...
	def infoCB(self, html):
		upng = "http://new.meteo.pl/um/metco/mgram_pict.php?ntype=0u&ffdate=%s&row=%s&col=%s&lang=pl"
